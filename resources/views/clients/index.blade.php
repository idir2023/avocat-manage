                ...
                <div class="carousel-item position-relative" >
                    ...
                    <div class="container-fluid bg-page-header">
                        <div class="container">
                            <div class="d-flex flex-column align-items-center justify-content-center"
                                style="min-height: 400px;">
                                <h3 class="display-3 text-white text-uppercase">Écoute & Engagement</h3>
                                <div class="p-3 text-center" style="max-width: 900px;">
                                    <p class="m-0 text-uppercase">
                                        <a class="text-white" href="/">Cabinet HB Avocats</a>
                                    </p>
                                    <h2 class="display-4 text-white mb-4">Un accompagnement juridique humain, efficace
                                        et
                                        rigoureux</h2>
                    ...
                    <div class="owl-carousel service-carousel position-relative"
                        ...
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-4 pb-4 shadow-sm"
                            ...
                            <p style="font-size: 17px;">
                                Assistance juridique en matière de propriété, titres fonciers, litiges de terrain,
                                morcellement, et régularisation des biens immobiliers.
                            </p>
                        </div>
                        <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-4 pb-4 shadow-sm"
                            style="min-height: 380px;">
            ...
            <div class="owl-carousel testimonial-carousel">
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-2"
                        ...
                        <p class="mb-4 testimonial-content" style="max-height: 150px; overflow: hidden;">
                            "I asked this lawyer, Hanan Bounit, to help me with a problem I had with a company. She was
                            professional, attentive and able to guide me effectively to resolve the situation. Thanks to
                            his help, I was able to overcome this obstacle. Allah i3teha lkhir 🙏🏻"
                        </p>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-2"
                        style="min-height: 360px;">
                        <p class="mb-4 testimonial-content" style="max-height: 150px; overflow: hidden;">
                            "I found Maitre Hanan Bounit to be an excellent and informed lawyer in Agadir. Her English
                            really surprised me, it was excellent and easy to understand. She really took the time to
                            understand what we needed. She was well equipped to handle questions about international
                            businesses and gave excellent advice. I am looking forward to continuing to work with her
                            and have her guidance."
                        </p>
                        <button class="btn btn-sm btn-light btn-read-more">Lire la suite</button>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-2"
                        style="min-height: 360px;">
                        <p class="mb-4 testimonial-content" style="max-height: 150px; overflow: hidden;">
                            "Exceptional Legal Service – Highly Recommended! I had the pleasure of working with Maitre
                            Hanane Bounit, and I couldn’t be more satisfied with the service provided. From the very
                            beginning, she demonstrated professionalism, expertise, and a genuine commitment to my case.
                            She explained every step of the process, answered all my questions, and gave clear guidance.
                            Thanks to her, my case was handled smoothly and successfully."
                        </p>
                        <button class="btn btn-sm btn-light btn-read-more">Lire la suite</button>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-2"
                        style="min-height: 360px;">
                        <p class="mb-4 testimonial-content" style="max-height: 150px; overflow: hidden;">
                            "A lawyer that I highly recommend! Human, attentive professionalism, and invested in her
                            work. I won my case with her, and I can never thank her enough for her wise advice which
                            greatly contributed to the result. Really great! 👌🏽"
                        </p>
                        <button class="btn btn-sm btn-light btn-read-more">Lire la suite</button>
                ...
                <div class="testimonial-item">
                    <div class="testimonial-text position-relative bg-secondary text-light rounded p-5 mb-2"
                        style="min-height: 360px;">
                        <p class="mb-4 testimonial-content" style="max-height: 150px; overflow: hidden;">
                            "I highly recommend Maître Hanane Bounit. She is a competent professional, attentive, and
                            always available to answer my questions. Her human approach and her ability to explain
                            things clearly reassured me throughout my process. Thanks to her expertise, my file was
                            handled efficiently and successfully. I am very grateful for her support."
                        </p>
                        <button class="btn btn-sm btn-light btn-read-more">Lire la suite</button>
