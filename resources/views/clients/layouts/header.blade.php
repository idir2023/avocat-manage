    ...
    <div class="row">
        <div class="col-lg-3 bg-secondary d-none d-lg-block">
            <a href="{{ route('home') }}" class="navbar-brand w-100 h-100 m-0 p-0 d-flex align-items-center justify-content-center">
                <h1 class="m-0 display-4 text-primary text-uppercase">{{ $settings->company_name ?? 'Justice' }}</h1>
            </a>
        </div>
        <div class="col-lg-9">
            <div class="row bg-white border-bottom d-none d-lg-flex">
                <div class="col-lg-7 text-left">
                    ...
                    <div class="h-100 d-inline-flex align-items-center py-2 px-2">
                        ...
                        <small>{{ $settings->phone_number ?? '+012 345 6789' }}</small>
                    </div>
                </div>
                <div class="col-lg-5 text-right">
                    <div class="d-inline-flex align-items-center p-2">
                        <a class="btn btn-sm btn-outline-primary btn-sm-square mr-2" href="{{ $socialMedia['facebook'] ?? '#' }}">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a class="btn btn-sm btn-outline-primary btn-sm-square mr-2" href="{{ $socialMedia['twitter'] ?? '#' }}">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a class="btn btn-sm btn-outline-primary btn-sm-square mr-2" href="{{ $socialMedia['linkedin'] ?? '#' }}">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a class="btn btn-sm btn-outline-primary btn-sm-square mr-2" href="{{ $socialMedia['instagram'] ?? '#' }}">
