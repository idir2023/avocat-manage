...
<div class="container-fluid py-5" style="background-color: #0e0e0e;">
    <div class="container text-center">
        <h2 class="text-white mb-5">Nos domaines d'expertise</h2>
        <div class="row justify-content-center">

            <!-- Service 1 -->
            <div class="col-md-4 col-lg-2 mb-5">
                <img src="{{ asset('clients/img/icon-travail.png') }}" alt="Droit du travail" style="height: 80px;">
                <h5 class="text-white mt-3 mb-2" style="font-size: 18px;">Droit du Travail</h5>
                <p class="text-white-50 small">Contrats, licenciements, harcèlement, heures supplémentaires, ruptures conventionnelles...</p>
            </div>

            <!-- Service 2 -->
            <div class="col-md-4 col-lg-2 mb-5">
                <img src="{{ asset('clients/img/icon-contrat.png') }}" alt="Droit des contrats" style="height: 80px;">
                <h5 class="text-white mt-3 mb-2" style="font-size: 18px;">Droit des Contrats</h5>
                <p class="text-white-50 small">Rédaction, analyse et négociation de contrats civils et commerciaux.</p>
            </div>

            <!-- Service 3 -->
            <div class="col-md-4 col-lg-2 mb-5">
                <img src="{{ asset('clients/img/icon-cse.png') }}" alt="Droit des CSE" style="height: 80px;">
                <h5 class="text-white mt-3 mb-2" style="font-size: 18px;">Droit des CSE</h5>
                <p class="text-white-50 small">Assistance juridique des comités sociaux et économiques (CSE), représentation, conseils.</p>
            </div>

            <!-- Service 4 -->
            <div class="col-md-4 col-lg-2 mb-5">
                <img src="{{ asset('clients/img/icon-conseil.png') }}" alt="Conseils juridiques" style="height: 80px;">
                <h5 class="text-white mt-3 mb-2" style="font-size: 18px;">Conseils Juridiques</h5>
                <p class="text-white-50 small">Éclairage juridique personnalisé pour sécuriser vos démarches ou projets.</p>
            </div>

            <!-- Service 5 -->
            <div class="col-md-4 col-lg-2 mb-5">
                <img src="{{ asset('clients/img/icon-formation.png') }}" alt="Formations professionnelles" style="height: 80px;">
                <h5 class="text-white mt-3 mb-2" style="font-size: 18px;">Formations Professionnelles</h5>
                <p class="text-white-50 small">Sessions de formation sur des thématiques juridiques pour entreprises ou salariés.</p>
            </div>
