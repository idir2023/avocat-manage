        ...
        <div class="container py-2">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="text-muted mb-3">
                        Trilingue <strong>Français, Anglais et Arabe</strong>, Me Hanane Bounit s’appuie sur un parcours académique solide : plusieurs masters en droit social a, droit des affaires, droit de l’entreprise, et une spécialisation en risques psychosociaux.
                    </p>
