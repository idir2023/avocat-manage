...
<div class="container-fluid py-5">
    <div class="container py-5">
        <div class="row align-items-center">
            ...
            <!-- Côté gauche : design stylé -->
            <div class="col-lg-5 text-center mb-4 mb-lg-0">
                <div style="position: relative; height: 250px;">
                   
                        <img class="position-absolute w-100 h-100" src="{{asset('clients/img/hb.jpeg')}}" style="object-fit: cover;" alt="Pourquoi choisir notre cabinet">
                    
                    <h1 style="font-size: 120px; color: #e3e1db; font-weight: 800; line-height: 1;">HB</h1>
                    <h3 style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 36px; color: #5a4c1d; letter-spacing: 2px;">QUI SOMMES-NOUS</h3>
                </div>
            </div>
