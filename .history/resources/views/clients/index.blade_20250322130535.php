        ...
        <div class="row">
            ...
            <div class="col-lg-9 pt-5 pt-lg-0">
                ...
                <div class="owl-carousel service-carousel position-relative" style="margin-top: -100px; padding: 0 30px;">
                    ...
                    <!-- Droit du travail -->
                    <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-3 pb-3 shadow-sm">
                        <div class="icon-box bg-secondary text-white mb-4">
                            <i class="fa fa-2x fa-briefcase"></i>
                        </div>
                        <h5 class="mb-3">Droit du travail</h5>
                        <p>Conseil & contentieux en matière de contrats, licenciements, harcèlement, ruptures conventionnelles, etc.</p>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-3 pb-3 shadow-sm">
                        ...
                        <h5 class="mb-3">Droit de la famille</h5>
                        <p>Divorce, pension alimentaire, garde d’enfants, filiation, et toutes questions liées à la vie familiale.</p>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-3 pb-3 shadow-sm">
                        ...
                        <h5 class="mb-3">Droit des étrangers</h5>
                        <p>Visa, régularisation, titres de séjour, recours contre OQTF, naturalisation, etc.</p>
                    </div>
                    ...
                    <div class="d-flex flex-column align-items-center text-center bg-white rounded pt-4 px-3 pb-3 shadow-sm">
                        ...
                        <h5 class="mb-3">Droit des affaires</h5>
                        <p>Création d’entreprise, contrats commerciaux, contentieux entre sociétés, recouvrement de créances.</p>
                    </div>
