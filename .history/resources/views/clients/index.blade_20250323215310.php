            ...
            <div class="carousel-item position-relative" style="height: 100vh; min-height: 400px;">
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3 text-center" style="max-width: 900px;">
                        ...
                        <a class="btn btn-primary py-3 px-5 mt-2" href=href="{{ route('register') }}">Prendre rendez-vous</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <a href="{{ route('register') }}" class="btn btn-primary mt-2">Prendre rendez-vous</a>
            </div>
