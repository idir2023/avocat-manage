        ...
        <div class="container py-2">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <p class="text-muted mb-3">
                        Trilingue <strong>Français, Anglais , Arabe et tamazigh</strong>, Maître Hanane Bounit s’appuie sur un parcours académique solide : plusieurs masters en droit social approfondie, droit des affaires, droit de l’entreprise ,droit civil et  droit de famille.
                    </p>
