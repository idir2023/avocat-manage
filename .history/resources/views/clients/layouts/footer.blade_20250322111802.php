   ...
   <div class="row pt-5 justify-content-center">
    ...
    <div class="col-lg-4 col-md-6 mb-5">
        ...
        <div class="d-flex flex-column align-items-center align-items-lg-start mt-4">
            <a class="text-white mb-2" href="{{route('home')}}"> <i class="fa fa-angle-right mr-2">Home</a> 
            <a class="text-white mb-2" href="{{route('about')}}">About</a>
            <a class="text-white mb-2" href="{{route('actualite')}}">Actualité</a>
            <a class="text-white mb-2" href="{{route('expertise')}}">Expertise</a>
