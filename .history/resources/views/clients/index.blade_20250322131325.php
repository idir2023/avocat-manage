...
<div class="container-fluid py-5" style="background-color: #0e0e0e;">
    <div class="container py-5">
        <div class="row">
            <!-- Bloc introduction -->
            <div class="col-lg-3">
                <h6 class="text-uppercase text-warning">Nos domaines</h6>
                <h1 class="mb-4 text-white">Domaines d’intervention</h1>
                <p class="text-white-50">Nous accompagnons nos clients dans divers domaines du droit, avec une approche humaine, stratégique et rigoureuse, adaptée à chaque situation personnelle ou professionnelle.</p>
                <a href="{{ route('contact') }}" class="btn btn-outline-light mt-2">Prendre rendez-vous</a>
            </div>
            ...
            <div class="col-lg-9 pt-5 pt-lg-0">
                <div class="row text-center justify-content-center g-4">
                    ...
                    <div class="col-md-4 col-lg-4 mb-5">
                        <img src="{{ asset('clients/img/icon-travail.png') }}" alt="Droit du Travail" style="height: 80px;">
                        <h5 class="text-white mt-3 mb-2" style="font-size: 20px;">Droit du Travail</h5>
                        <p class="text-white-50">Litiges salariés/employeurs, licenciements, harcèlement, heures supplémentaires...</p>
                    </div>

                    <!-- Droit des contrats -->
                    <div class="col-md-4 col-lg-4 mb-5">
                        <img src="{{ asset('clients/img/icon-contrat.png') }}" alt="Droit des Contrats" style="height: 80px;">
                        <h5 class="text-white mt-3 mb-2" style="font-size: 20px;">Droit des Contrats</h5>
                        <p class="text-white-50">Rédaction, analyse, et négociation de contrats civils ou commerciaux.</p>
                    </div>

                    <!-- Droit des CSE -->
                    <div class="col-md-4 col-lg-4 mb-5">
                        <img src="{{ asset('clients/img/icon-cse.png') }}" alt="Droit des CSE" style="height: 80px;">
                        <h5 class="text-white mt-3 mb-2" style="font-size: 20px;">Droit des CSE</h5>
                        <p class="text-white-50">Conseil aux représentants du personnel et accompagnement juridique des CSE.</p>
                    </div>

                    <!-- Conseils juridiques -->
                    <div class="col-md-4 col-lg-4 mb-5">
                        <img src="{{ asset('clients/img/icon-conseil.png') }}" alt="Conseils juridiques" style="height: 80px;">
                        <h5 class="text-white mt-3 mb-2" style="font-size: 20px;">Conseils Juridiques</h5>
                        <p class="text-white-50">Orientation et analyse juridique personnalisée pour prévenir ou résoudre les litiges.</p>
                    </div>

                    <!-- Formations professionnelles -->
                    <div class="col-md-4 col-lg-4 mb-5">
                        <img src="{{ asset('clients/img/icon-formation.png') }}" alt="Formations professionnelles" style="height: 80px;">
                        <h5 class="text-white mt-3 mb-2" style="font-size: 20px;">Formations Professionnelles</h5>
                        <p class="text-white-50">Sessions de formation juridique adaptées aux besoins des entreprises et salariés.</p>
                    </div>
