...
<div class="container-fluid py-5">
   ...
   <!-- Bloc gauche avec logo HB en image et texte superposé -->
<!-- Bloc gauche avec logo HB en image (agrandi) et texte superposé -->
<div class="col-lg-5 text-center mb-4 mb-lg-0 d-flex align-items-center" style="min-height: 400px;">
    <div style="position: relative; width: 100%; height: 100%;">
        <h2 style="font-size: 180px; color: #e0dfd8; font-weight: 700; line-height: 1;">HB</h2>
